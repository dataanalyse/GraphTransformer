...
def main() -> None:
    ...
    out_path = Path(args.out_path) if args.out_path else runs_root / "results_summary.csv"
            ...
            for run_dir in sorted([p for p in exp_dir.iterdir() if p.is_dir()]):
                ...
                if metrics_path.exists():
                    ...
                    if mrows:
                        ...
                        mae_vals = []
                        for row in mrows:
                            value = row.get("test_mae", "")
                            try:
                                mae_vals.append(float(value))
                            except Exception:
                                pass
                        if mae_vals:
                            best_test_mae = min(mae_vals)
                ...
                rows.append(
                    {
                        ...
                        "feature_variant": cfg.get("feature_variant", ""),
                        "active_features": ds.get(
                        ...
                        "seed": cfg.get("seed", ""),
                        "prediction_horizon": ds.get(
                            "prediction_horizon", cfg.get("prediction_horizon", "")
                        ),
                        "split_mode": cfg.get("split_mode", ""),
                        "train_seeds": cfg.get("train_seeds", ""),
                        "test_seeds": cfg.get("test_seeds", ""),
                        "graph_target_name": cfg.get("graph_target_name", ""),
                        "graph_target_desc": cfg.get("graph_target_desc", ""),
                        ...
                        "max_dist": cfg.get("max_dist", ""),
                        "max_degree": cfg.get("max_degree", ""),
